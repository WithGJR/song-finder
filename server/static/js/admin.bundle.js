...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] admin/components/SongList.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  vuex: {
	    getters: {
	      songs: _getters.getSongs,
	      singers: _getters.getSingers,
	  ...
	  computed: {
	    haveNoSongs: function haveNoSongs() {
	      return !this.isLoading && this.songs.length === 0;
	    }
	  },
	  methods: {
	    albumName: function albumName(albumId) {
	    ...
	    singerName: function singerName(singerId) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  getSongs: function getSongs(_ref) {
	    var songs = _ref.songs;

	    return songs.all;
	  },
	  getSingers: function getSingers(_ref2) {
	    var singers = _ref2.singers;

	    return singers.all;
	  },
	  getAlbums: function getAlbums(_ref3) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  fetchSongs: function fetchSongs(_ref) {
	    var dispatch = _ref.dispatch;

	    dispatch(_mutationTypes2.default.FETCH_SONGS_REQEUST);

	    _api2.default.fetchAllSongs(function (songs) {
	      dispatch(_mutationTypes2.default.FETCH_SONGS_SUCESS, songs);
	    });
	  },
	  addNewSong: function addNewSong(_ref2, newSong) {
	    var dispatch = _ref2.dispatch;

	    _api2.default.addNewSong(newSong, function (song) {
	      dispatch(_mutationTypes2.default.ADD_NEW_SONG, song);
	    });
	  },
	  updateSong: function updateSong(_ref3, id, song) {
	    var dispatch = _ref3.dispatch;

	    _api2.default.updateSong(id, song, function (updatedSong) {
	      dispatch(_mutationTypes2.default.UPDATE_SONG_SUCESS, updatedSong.ID, updatedSong);
	    });
	  },
	  deleteSong: function deleteSong(_ref4, id) {
	    var dispatch = _ref4.dispatch;

	    _api2.default.deleteSong(id, function (deletedSongId) {
	      dispatch(_mutationTypes2.default.DELETE_SONG, deletedSongId);
	    });
	  },
	  fetchSingers: function fetchSingers(_ref5) {
	    var dispatch = _ref5.dispatch;

	    dispatch(_mutationTypes2.default.FETCH_SINGERS_REQUEST);
	    _api2.default.fetchAllSingers(function (singers) {
	      dispatch(_mutationTypes2.default.FETCH_SINGERS_SUCESS, singers);
	    });
	  },
	  addNewSinger: function addNewSinger(_ref6, newSinger) {
	    var dispatch = _ref6.dispatch;

	    _api2.default.addNewSinger(newSinger, function (singer) {
	      dispatch(_mutationTypes2.default.ADD_NEW_SINGER, singer);
	    });
	  },
	  updateSinger: function updateSinger(_ref7, id, singer) {
	    var dispatch = _ref7.dispatch;

	    _api2.default.updateSinger(id, singer, function (updatedSinger) {
	      dispatch(_mutationTypes2.default.UPDATE_SINGER_SUCESS, updatedSinger.ID, updatedSinger);
	    });
	  },
	  deleteSinger: function deleteSinger(_ref8, id) {
	    var dispatch = _ref8.dispatch;

	    _api2.default.deleteSinger(id, function (deletedSingerId) {
	      dispatch(_mutationTypes2.default.DELETE_SINGER, deletedSingerId);
	    });
	  },
	  fetchAlbums: function fetchAlbums(_ref9) {
	    var dispatch = _ref9.dispatch;

	    _api2.default.fetchAllAlbums(function (albums) {
	      dispatch(_mutationTypes2.default.FETCH_ALBUMS_SUCESS, albums);
	    });
	  },
	  addNewAlbum: function addNewAlbum(_ref10, newAlbum) {
	    var dispatch = _ref10.dispatch;

	    _api2.default.addNewAlbum(newAlbum, function (album) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _domainName = ''; // In Production

	module.exports = {
	  fetchAllSongs: function fetchAllSongs(successCallback) {
	    fetch(_domainName + '/songs', {
	      credentials: 'same-origin'
	    }).then(function (data) {
	      data.json().then(function (songs) {
	        successCallback(songs);
	      });
	    }).catch(function (error) {});
	  },
	  addNewSong: function addNewSong(song, successCallback) {
	    ...
	    fetch(_domainName + '/songs', {
	      ...
	      data.json().then(function (createdSong) {
	        successCallback(createdSong);
	      });
	    }).catch(function (error) {});
	  },
	  updateSong: function updateSong(id, song, successCallback) {
	    var headers = new Headers();
	    headers.append('Content-Type', 'application/json');
	    headers.append('Accept', 'application/json');
	    ...
	    fetch(_domainName + '/songs/' + id, {
	      ...
	      data.json().then(function (updatedSong) {
	        successCallback(updatedSong);
	      });
	    }).catch(function (error) {});
	  },
	  deleteSong: function deleteSong(id, successCallback) {
	    fetch(_domainName + '/songs/' + id, {
	      method: 'delete',
	      credentials: 'same-origin'
	    }).then(function (data) {
	      data.json().then(function (id) {
	        successCallback(id);
	      });
	    }).catch(function (error) {});
	  },
	  fetchAllSingers: function fetchAllSingers(successCallback) {
	  ...
	  addNewSinger: function addNewSinger(singer, successCallback) {
	    var headers = new Headers();
	    headers.append('Content-Type', 'application/json');
	    headers.append('Accept', 'application/json');
	  ...
	  updateSinger: function updateSinger(id, singer, successCallback) {
	    var headers = new Headers();
	    headers.append('Content-Type', 'application/json');
	    headers.append('Accept', 'application/json');
	    ...
	    fetch(_domainName + '/singers/' + id, {
	      ...
	      data.json().then(function (updatedSinger) {
	        successCallback(updatedSinger);
	      });
	    }).catch(function (error) {});
	  },
	  deleteSinger: function deleteSinger(id, successCallback) {
	    fetch(_domainName + '/singers/' + id, {
	      method: 'delete',
	      credentials: 'same-origin'
	    }).then(function (data) {
	  ...
	  fetchAllAlbums: function fetchAllAlbums(successCallback) {
	    fetch(_domainName + '/albums', {
	      credentials: 'same-origin'
	    }).then(function (data) {
	      data.json().then(function (albums) {
	        successCallback(albums);
	      });
	    }).catch(function (error) {});
	  },
	  uploadAlbumPhoto: function uploadAlbumPhoto(albumId, photo, successCallback) {
	  ...
	  addNewAlbum: function addNewAlbum(album, successCallback) {
	    var headers = new Headers();
	    headers.append('Content-Type', 'application/json');
	    headers.append('Accept', 'application/json');
	  ...
	  deleteAlbum: function deleteAlbum(id, successCallback) {
	    fetch(_domainName + '/albums/' + id, {
	      method: 'delete',
	      credentials: 'same-origin'
	    }).then(function (data) {
...
/***/ function(module, exports) {
	...
	module.exports = {
	  ...
	  FETCH_SINGERS_REQUEST: 'FETCH_SINGERS_REQUEST',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/SongForm.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BaseForm = __webpack_require__(51);
	...
	module.exports = {
	  vuex: {
	    ...
	    actions: {
	      ...
	      updateSong: _actions.updateSong
	    }
	  },
	  mixins: [_BaseForm2.default],
	  data: function data() {
	    return {
	      song: (0, _assign2.default)({}, songModel)
	    };
	  },

	  computed: {
	    newFormTitle: function newFormTitle() {
	      return '新增歌曲';
	    },
	    editFormTitle: function editFormTitle() {
	      return '修改歌曲';
	    },
	    newFormBtnText: function newFormBtnText() {
	      return '確認新增';
	    },
	    editFormBtnText: function editFormBtnText() {
	      return '確認更新';
	    },
	  ...
	  methods: {
	    ...
	    submit: function submit() {
	      ...
	      if (this.formType === 'edit') {
	        ...
	        this.song = (0, _assign2.default)({}, songModel);
	      }
	    }
	  },
	  ready: function ready() {
	    if (this.formType == 'edit') {
	      this.song = (0, _assign2.default)({}, this.currentSong);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/SingerList.vue: named exports in *.vue files are ignored.")}
	...
	module.exports = {
	  vuex: {
	    getters: {
	      singers: _getters.getSingers,
	      isLoading: function isLoading(_ref) {
	        var singers = _ref.singers;
	        return singers.isLoading;
	      }
	    },
	    actions: {
	      deleteSinger: _actions.deleteSinger
	    }
	  },
	  computed: {
	    haveNoSingers: function haveNoSingers() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/SingerForm.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var singerModel = { Name: '', Country: '' };

	module.exports = {
	  vuex: {
	    actions: {
	      addNewSinger: _actions.addNewSinger,
	      updateSinger: _actions.updateSinger
	    },
	    getters: {
	      singers: _getters.getSingers
	    }
	  ...
	  computed: {
	    ...
	    currentSinger: function currentSinger() {
	      for (var i = 0; i < this.singers.length; i++) {
	  ...
	  data: function data() {
	    return {
	      singer: (0, _assign2.default)({}, singerModel)
	    };
	  },
	  ready: function ready() {
	    if (this.formType == 'edit') {
	      this.singer = (0, _assign2.default)({}, this.currentSinger);
	    }
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/AlbumList.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  vuex: {
	    ...
	    actions: {
	      deleteAlbum: _actions.deleteAlbum
	    }
	  },
	  computed: {
	    haveNoAlbums: function haveNoAlbums() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/AlbumForm.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var albumModel = { Name: '', Company: '', PublishedDate: '', Language: '', Reward: '', Photo: '' };
	...
	module.exports = {
	  ...
	  computed: {
	    ...
	    currentAlbum: function currentAlbum() {
	      for (var i = 0; i < this.albums.length; i++) {
	  ...
	  data: function data() {
	    return {
	      album: (0, _assign2.default)({}, albumModel)
	    };
	  },
	  ready: function ready() {
	    if (this.formType == 'edit') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/UploadAlbumPhotoForm.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "./UploadAlbumPhotoForm.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	  vuex: {
	    actions: {
	      uploadAlbumPhoto: _actions.uploadAlbumPhoto
	    },
	    getters: {
	      albums: _getters.getAlbums
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] admin/components/App.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _actions.fetchSongs)(_store2.default);
	(0, _actions.fetchSingers)(_store2.default);
	(0, _actions.fetchAlbums)(_store2.default);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singers = __webpack_require__(73);

	var _singers2 = _interopRequireDefault(_singers);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = (_mutations = {}, _defineProperty(_mutations, _mutationTypes2.default.FETCH_SONGS_REQEUST, function (state) {
	  state.all = [];
	  state.isLoading = true;
	}), _defineProperty(_mutations, _mutationTypes2.default.FETCH_SONGS_SUCESS, function (state, songs) {
	  state.all = songs;
	  state.isLoading = false;
	}), _defineProperty(_mutations, _mutationTypes2.default.FETCH_SONGS_FAILURE, function (state) {}), _defineProperty(_mutations, _mutationTypes2.default.ADD_NEW_SONG, function (state, song) {
	  state.all.push(song);
	}), _defineProperty(_mutations, _mutationTypes2.default.UPDATE_SONG_SUCESS, function (state, id, newSong) {
	...
	}), _defineProperty(_mutations, _mutationTypes2.default.DELETE_SONG, function (state, id) {
	  for (var i = 0; i < state.all.length; i++) {
	    if (state.all[i].ID === id) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = (_mutations = {}, _defineProperty(_mutations, _mutationTypes2.default.FETCH_SINGERS_REQUEST, function (state) {
	  state.isLoading = true;
	}), _defineProperty(_mutations, _mutationTypes2.default.FETCH_SINGERS_SUCESS, function (state, singers) {
	  state.all = singers;
	  state.isLoading = false;
	}), _defineProperty(_mutations, _mutationTypes2.default.ADD_NEW_SINGER, function (state, singer) {
	  state.all.push(singer);
	}), _defineProperty(_mutations, _mutationTypes2.default.UPDATE_SINGER_SUCESS, function (state, id, newSinger) {
	  for (var i = 0; i < state.all.length; i++) {
	    if (state.all[i].ID === id) {
	...
	}), _defineProperty(_mutations, _mutationTypes2.default.DELETE_SINGER, function (state, id) {
	  for (var i = 0; i < state.all.length; i++) {
	    if (state.all[i].ID === id) {
	      state.all.splice(i, 1);
	      return;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mutations = (_mutations = {}, _defineProperty(_mutations, _mutationTypes2.default.FETCH_ALBUMS_SUCESS, function (state, albums) {
	  state.all = albums;
	}), _defineProperty(_mutations, _mutationTypes2.default.ADD_NEW_ALBUM, function (state, album) {
	  state.all.push(album);
	}), _defineProperty(_mutations, _mutationTypes2.default.UPLOAD_ALBUM_PHOTO_SUCESS, function (state, upadatedAlbum) {
	  for (var i = 0; i < state.all.length; i++) {
